...
function renderizarPizzas(pizzas) {
  ...
  pizzas.forEach((pizza) => {
    ...
    pizzaCard.className =
      "pizza-card bg-white dark:bg-gray-700 rounded-xl shadow-lg overflow-hidden";
      ...
      pizza.nombre
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-2">
                        ...
                        <span class="text-lg font-bold text-pizza-red">$${pizza.precio.toFixed(
                          2
                        )}</span>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-700 dark:text-gray-300">${pizza.ingredientes.join(
                          ", "
                        )}</p>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600 dark:text-gray-300">${
                              pizza.tiempoPreparacion
                            } min</span>
                        </div>
                        <button class="añadir-carrito-btn bg-pizza-red hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition-colors" data-id="${
                          pizza.id
                        }">
...
function mostrarDatosEjemplo() {
  ...
  if (container) {
    ...
    advertencia.className =
      "col-span-3 text-center p-4 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded-lg mb-4";
